...
namespace Rlgl {
    ...
    [CCode (cname = "RL_READ_FRAMEBUFFER")]
    public const int READ_FRAMEBUFFER; // GL_READ_FRAMEBUFFER

    [CCode (cname = "RL_DRAW_FRAMEBUFFER")]
    public const int DRAW_FRAMEBUFFER; // GL_DRAW_FRAMEBUFFER
    ...
    public struct VertexBuffer {
        [CCode (cname = "elementCount")]
        public int element_count; // Number of elements in the buffer (QUADS)
        ...
        [CCode (cname = "vboId")]
        public unowned uint vbo_id[4]; // OpenGL Vertex Buffer Objects id (4 types of vertex data)
    }
    ...
    public struct DrawCall {
        ...
        [CCode (cname = "vertex_count")]
        public int vertexCount; // Number of vertex of the draw

        [CCode (cname = "vertex_alignment")]
        public int vertexAlignment; // Number of vertex required for index alignment (LINES, TRIANGLES)

        [CCode (cname = "textureId")]
        public uint texture_id; // Texture id to be used on the draw -> Use to create new draw call if changes
    }
    ...
    public struct RenderBatch {
        [CCode (cname = "currentBuffer")]
        public int current_buffer; // Current buffer tracking in case of multi-buffering

        [CCode (cname = "vertexBuffer", array_length_cname = "bufferCount", array_length_type = "int")]
        public unowned VertexBuffer[] vertex_buffer; // Dynamic buffer(s) for vertex data

        [CCode (array_length_cname = "drawCounter", array_length_type = "int")]
        public unowned DrawCall[] draws; // Draw calls array, depends on textureId

        [CCode (cname = "currentDepth")]
    ...
    public enum GlVersion {
        OPENGL_SOFTWARE, // Software rendering
    ...
    [CCode (cname = "rlPixelFormat", has_type_id = false, cprefix = "RL_PIXELFORMAT_")]
    public enum PixelFormat {
        ...
        [CCode (cname = "RL_PIXELFORMAT_COMPRESSED_ASTC_4x4_RGBA")]
        COMPRESSED_ASTC_4X4_RGBA,
        [CCode (cname = "RL_PIXELFORMAT_COMPRESSED_ASTC_8x8_RGBA")]
        COMPRESSED_ASTC_8X8_RGBA // 2 bpp
    }

    // Texture parameters: filter mode
    [CCode (cname = "rlTextureFilter", has_type_id = false, cprefix = "RL_TEXTURE_FILTER_")]
    ...
    [CCode (cname = "rlBlendMode", has_type_id = false, cprefix = "RL_BLEND_")]
    ...
    [CCode (cname = "rlShaderLocationIndex", has_type_id = false, cprefix = "RL_SHADER_LOC_")]
    ...
    [CCode (cname = "rlShaderUniformDataType", cprefix = "RL_SHADER_", has_type_id = false)]
    public enum ShaderUniformDataType {
        UNIFORM_FLOAT, // Shader uniform type: float
    ...
    public enum FramebufferAttachType {
        COLOR_CHANNEL0, // Framebuffer attachment type: color 0
        ...
        DEPTH, // Framebuffer attachment type: depth
        STENCIL // Framebuffer attachment type: stencil
    }
    ...
    public enum FramebufferAttachTextureType {
        CUBEMAP_POSITIVE_X, // Framebuffer texture attachment type: cubemap, +X side
        ...
        TEXTURE2D, // Framebuffer texture attachment type: texture2d
        RENDERBUFFER // Framebuffer texture attachment type: renderbuffer
    }

    // Face culling mode
    [CCode (cname = "rlCullMode", cprefix = "RL_CULL_", has_type_id = false)]
    ...
    [CCode (cname = "rlSetClipPlanes")]
    public static void rl_set_clip_planes (double near_plane, double far_plane); // Set clip planes distances

    [CCode (cname = "rlGetCullDistanceNear")]
    public static double rl_get_cull_distance_near (); // Get cull plane distance near

    [CCode (cname = "rlGetCullDistanceFar")]
    public static double rl_get_cull_distance_far (); // Get cull plane distance far
    ...
    [CCode (cname = "rlGetActiveFramebuffer")]
    public static uint rl_get_active_framebuffer ();

    [CCode (cname = "rlActiveDrawBuffers")]
    public static void rl_active_draw_buffers (int count); // Activate multiple draw color buffers

    [CCode (cname = "rlBlitFramebuffer")]
    public static void rl_blit_framebuffer (int src_x, int src_y, int src_width, int src_height, int dst_x, int dst_y,
                                            int dst_width, int dst_height, int buffer_mask); // Blit active framebuffer to main framebuffer

    [CCode (cname = "rlBindFramebuffer")]
    public static void rl_bind_framebuffer (uint target, uint framebuffer); // Bind framebuffer (FBO)
    ...
    [CCode (cname = "rlColorMask")]
    public static void rl_color_mask (bool r, bool g, bool b, bool a); // Color mask control
    ...
    [CCode (cname = "rlEnablePointMode")]
    public static void rl_enable_point_mode (); // Enable point mode

    [CCode (cname = "rlDisablePointMode")]
    public static void rl_disable_point_mode (); // Disable point mode

    [CCode (cname = "rlSetPointSize")]
    public static void rl_set_point_size (float size); // Set the point drawing size

    [CCode (cname = "rlGetPointSize")]
    public static float rl_get_point_size (); // Get the point drawing size
    ...
    [CCode (cname = "rlGetProcAddress")]
    public static void * rl_get_proc_address (string proc_name); // Get OpenGL procedure address
    ...
    [CCode (cname = "rlGetShaderLocsDefault", array_length = false)]
    ...
    [CCode (cname = "rlCopyFramebuffer")]
    public static void rl_copy_framebuffer (int x, int y, int width, int height, int format, void *pixels); // Copy framebuffer pixel data to internal buffer

    [CCode (cname = "rlResizeFramebuffer")]
    public static void rl_resize_framebuffer (int width, int height); // Resize internal framebuffer
    ...
    [CCode (cname = "rlLoadShaderProgramEx")]
    public static uint rl_load_shader_program_ext (uint vertex_shader_id, uint fragment_shader_id); // Load shader program, using already loaded shader ids

    [CCode (cname = "rlLoadShaderProgramCompute")]
    public static uint rl_load_shader_program_compute (uint compute_shader_id); // Load compute shader program

    [CCode (cname = "rlUnloadShader")]
    public static void rl_unload_shader (uint id); // Unload shader, loaded with rl_load_shader ()
    ...
    public static void rl_set_uniform_matrices (int location_index, Matrix[] matrix); // Set shader value matrices
