...
*       2.2 (05-Feb-2019) ADDED: GuiScrollBar(), GuiScrollPanel(), reviewed GuiListView(), removed RayGui*Ex() controls
...
//----------------------------------------------------------------------------------
// RayGui control property style color element
typedef enum { BORDER = 0, BASE, TEXT, OTHER } GuiPropertyElement;

//----------------------------------------------------------------------------------
// Global Variables Definition
//----------------------------------------------------------------------------------
static GuiState guiState = STATE_NORMAL;        // RayGui global state, if !STATE_NORMAL, forces defined state

static Font guiFont = { 0 };                    // RayGui current font (WARNING: highly coupled to raylib)
static bool guiLocked = false;                  // RayGui lock state (no inputs processed)
static float guiAlpha = 1.0f;                   // RayGui controls transparency

static unsigned int guiIconScale = 1;           // RayGui icon default scale (if icons enabled)
...
static bool guiControlExclusiveMode = false;    // RayGui control exclusive mode (no inputs processed except current control)
static Rectangle guiControlExclusiveRec = { 0 }; // RayGui control exclusive bounds rectangle, used as an unique identifier
...
static void GuiDrawText(const char *text, Rectangle textBounds, int alignment, Color tint); // RayGui draw text using default font
static void GuiDrawRectangle(Rectangle rec, int borderWidth, Color borderColor, Color color); // RayGui draw rectangle using default raygui style
...
//----------------------------------------------------------------------------------
// RayGui Setup Functions Definition
//----------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------
// RayGui Controls Functions Definition
//----------------------------------------------------------------------------------
...
// RayGui draw text using default font
...
// RayGui draw rectangle using default raygui plain style with borders
